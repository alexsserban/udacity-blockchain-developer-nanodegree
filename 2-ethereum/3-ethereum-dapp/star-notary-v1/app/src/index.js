...
import starNotaryV1Artifact from "../../build/contracts/StarNotaryV1.json"; // Importing the JSON representation of the Smart Contract
...
const App = {
    ...
    start: async function () {
        ...
        try {
            ...
            const deployedNetwork = starNotaryV1Artifact.networks[networkId]; // Retrieve the Network configuration from truffle-config.js file
            this.meta = new web3.eth.Contract(starNotaryV1Artifact.abi, deployedNetwork.address); // Initializing the contract
